...
@include('partials.notif')
                  	  ...
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Create Chair</h4>
                      <form class="form-horizontal style-form" method="post" action="{{ url('admin/manage/chair/store') }}">
                      	{{ csrf_field() }} 
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Chair Number</label>
                              <div class="col-sm-10">
                                  <input type="number" class="form-control" name="chair_number">
                              </div>
                          </div>
                           <div class="form-group">
                              <div class="col-md-12">
